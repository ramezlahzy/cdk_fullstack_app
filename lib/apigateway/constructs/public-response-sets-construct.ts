...
export const createPublicSurveyEndpoint = (OdAppCdkStack: cdk.Stack, tables: tablesType, reportResources: any, api: LambdaRestApi) => {
    // Surveys
    const sureysLambda = new Function(OdAppCdkStack, "PublicResponseSetsHandler", {
    ...
    const surveys = api.root.addResource("public-surveys");
